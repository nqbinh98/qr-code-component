...
- Solution URL: [Solution URL here](https://www.frontendmentor.io/solutions/semantic-html5-markup-and-css-custom-properties-and-flexbox-0y2MrWvxra)
- Live Site URL: [Live site URL here](https://nqbinh98.github.io/qr-code-component/)
...
- Code Optimization: Switched from multiple <p> tags to a more semantic <h1> and <p> structure.
